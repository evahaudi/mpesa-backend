...
ALLOWED_HOSTS = ["*"]
# WSGI_APPLICATION = 'barbershop.wsgi.app'
WSGI_APPLICATION = 'barbershop.wsgi.application'


# Add your M-Pesa Daraja API credentials
MPESA_CONSUMER_KEY = '5JOUVeZWNeuGn5PfYq37SWRGbHiHbHeAsMztbdnqBUrNVIzO'
MPESA_CONSUMER_SECRET = 'LSWg8pbxBXAjOfLXYtTnTkCedsAeAVijQqEJ1hQNp9WU1z86gL9jOnALXm4GsnOA'
